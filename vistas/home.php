...
?>
  ...
  <div>
    ...
    <p> ¿Quieres ver las ultimas noticias de nuestra comunidad? Explora nuestro blog para que puedas enterarte de todas las novedades, tips y anecdotas curiosas de nuestro equipo y nuestra comunidad.</p>
    ...
    <article>
      ...
      <div>
        ...
        <p>
          ...
          Llena nuestro formulario y en la brevedad nos pondremos en contacto con vos para darte información o suscribirte a nuestro <abbr title="Boletin informativo">newsletter</abbr> 
        </p>
